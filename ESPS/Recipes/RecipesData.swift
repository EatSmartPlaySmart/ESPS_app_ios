...
let recipeList = [
    Recipe(imageName: "recipe_corn_fritters",
           ...
           prepTime: 15,
           cookTime: 10,
           ingredients: [Ingredient(item: "Frozen sweet corn kernels", qty: "1.5 cups"),
                         Ingredient(item: "Spring onions – with green tops, sliced", qty: "4 onions"),
                         Ingredient(item: "Capsicum – seeds removed - chopped", qty: "1 small"),
                         Ingredient(item: "Parsley or chives – chopped", qty: "1/4 cup"),
                         ...
                         Ingredient(item: "Milk", qty: "1/2 cup"),
                         Ingredient(item: "Wholemeal self-raising flour", qty: "1 cup"),
                         Ingredient(item: "Canola oil for cooking", qty: "1 tbsp")],
    ...
    Recipe(imageName: "recipe_quick_creamy_porridge", title: "Quick, creamy porridge",
           ...
           prepTime: 5,
           cookTime: 15,
           ingredients: [Ingredient(item: "Quick-cooking oats", qty: "3 cups"),
                         Ingredient(item: "Water", qty: "3 cups"),
                         Ingredient(item: "Milk – any milk of your choice", qty: "4 cups")],
    ...
    Recipe(imageName: "recipe_broccoli_and_green_pea_soup",
           ...
           ingredients: [Ingredient(item: "Olive oil", qty: "1 tbsp"),
                         ...
                         Ingredient(item: "Reduced fat milk", qty: "1.5 cups"),
    ...
    Recipe(imageName: "recipe_banana_piklet",
           ...
           ingredients: [Ingredient(item: "Bananas, peeled, mashed – see Quick tip below", qty: "2"),
                         ...
                         Ingredient (item: "Wholemeal self-raising flour", qty: "2 1/3 cups"),
    ...
    Recipe(imageName: "recipe_tomato_red_lentil_and_vegetable_soup",
           ...
           ingredients: [Ingredient(item: "Olive oil", qty: "1 tbsp"),
                         Ingredient(item: "Onions, chopped", qty: "1"),
                         Ingredient(item: "Split red lentils", qty: "3/4 cup"),
                         Ingredient(item: "Boiling water", qty: "2.5 cups"),
                         Ingredient(item: "Jap pumpkin, peeled and chopped", qty: "200g"),
                         Ingredient (item: "Salt reduced tomato paste sauce", qty: "2.5 cups"),
    ...
    Recipe(imageName: "recipe_baked_meatballs",
           ...
           ingredients: [Ingredient(item: "Lean minced beef", qty: "600 g"),
                         ...
                         Ingredient(item: "Sweet chilli sauce", qty: "1 tbsp"),
                         Ingredient(item: "Dried breadcrumbs", qty: "2 cups"),
    ...
    Recipe(imageName: "recipe_super_salsa",
           ...
           ingredients: [Ingredient(item: "Olive oil", qty: "2 tbsp"),
                         ...
                         Ingredient(item: "Ground pepper", qty: "")],
    ...
    Recipe(imageName: "recipe_carrot_and_sultana_muffins",
           ...
           desc: "These are really moist and fruity muffins, and this recipe is suitable for involving children!",
           ...
           ingredients: [Ingredient(item: "Canola oil, plus extra for greasing", qty: "1/4 cup"),
                         ...
                         Ingredient(item: "Honey", qty: "1/4 cup"),
                         Ingredient(item: "Brown sugar", qty: "1/4 cup"),
                         Ingredient(item: "Eggs, beaten", qty: "2"),
                         Ingredient(item: "Sultanas", qty: "1/3 cup"),
                         Ingredient(item: "Milk – any milk of your choice", qty: "1/4 cup"),
                         Ingredient(item: "White self-raising flour", qty: "1 cup"),
                         Ingredient (item: "Wholemeal self-raising flour", qty: "3/4 cup"),
